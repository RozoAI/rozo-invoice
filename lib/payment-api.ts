...
export enum PaymentStatus {
  ...
  PaymentErrorLiquidity = "payment_error_liquidity",
  PaymentErrorRecipientTrustline = "payment_error_recipient_trustline",
  PaymentPayinCompleted = "payment_payin_completed",
  PaymentPayoutStarted = "payment_payout_started",
