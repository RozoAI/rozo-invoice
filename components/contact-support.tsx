      ...
      {isExpanded && (
        <div className="grid grid-cols-6 items-center gap-2 flex-wrap animate-in slide-in-from-top-2 duration-200">
          <a
            ...
            className="col-span-2 flex items-center gap-2 px-3 py-2 text-sm bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors rounded-lg border border-blue-200 dark:border-blue-800"
          >
            <svg
              className="size-4"
            ...
            <span className="font-medium text-xs sm:text-base">Twitter</span>
          </a>
          <a
            href="https://discord.com/invite/EfWejgTbuU"
            target="_blank"
            rel="noopener noreferrer"
            className="col-span-2 flex items-center gap-2 px-3 py-2 text-sm bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors rounded-lg border border-indigo-200 dark:border-indigo-800"
          >
            ...
            <span className="font-medium text-xs sm:text-base">Discord</span>
          </a>
          <a
            href="https://wa.me/14088925415?text=Hi%2C%20I'd%20like%20to%20contact%20you%20about%20your%20services."
            target="_blank"
            rel="noopener noreferrer"
            className="col-span-2 flex items-center gap-2 px-3 py-2 text-sm bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors rounded-lg border border-green-200 dark:border-green-800"
          >
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <span className="font-medium text-xs sm:text-base">Telegram</span>
          </a>
          <button
            type="button"
